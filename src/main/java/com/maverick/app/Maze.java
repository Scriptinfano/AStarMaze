...
public class Maze {
     ...
     * 候选点是否已经在候选列表中出现已经由{@link WallBreaker}类对象检查，所以该接口只需要再检查两个条件即可，以下是所有条件，此接口仅检查部分条件
     * <p>
     * 什么样的点可以加入候选点容器:
     * <p>
     * 1、不在迷宫边界上以及之外的点（所有待验证的路径点经过getPathPoint的过滤，一定不会出现坐标在迷宫之外的路径点）
     * <p>
     * 2、不在已经加入路径集合中的点
     * <p>
     * 3、不在候选列表中的点(碎墙器已经检查了此条件)
     * <p>
     * 4、不在原本是墙点上的点
     *
    ...
    static class PathPoint implements Comparable<PathPoint> {
        ...
        /**
         * 标识该路径点是否是最后求解完迷宫之后，迷宫起点到终点的唯一一条路径，该字段有三种情况：
         * <p>
         * 1、null: 该路径点上有墙
         * <p>
         * 2、true: 该路经点属于起点到终点的通路
         * <p>
         ...
         * <a href=
         * "https://www.bilibili.com/video/BV1xp4y1r7Ng/?p=3&share_source=copy_web&vd_source=ecaf67eab86977249adc291d11e7fa19">视频链接</a>
         */
